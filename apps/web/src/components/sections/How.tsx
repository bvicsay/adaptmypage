    ...
    <section id="how">
      <div className="mx-auto grid max-w-6xl gap-14 px-6 py-28 sm:px-10 lg:grid-cols-2 lg:gap-20">
        <SectionHeader
          ...
          title={<>Watch. Decide.<br /><span className="serif-italic">Change</span> the page.</>}
          lede="The SDK collects semantic events. One route turns them into typed answers with probabilities in about 300 ms. Your code reads the answers as normal flags. No generated text, nothing to parse."
        />
